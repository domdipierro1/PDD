...
export function contractorPaymentDue(job: Pick<Job, "payment_cleared" | "completion_form_submitted" | "qa_status" | "property_secured" | "payment_hold" | "customer_issue" | "contractor_issue" | "contractor_paid">) {
  return Boolean(
    job.payment_cleared &&
